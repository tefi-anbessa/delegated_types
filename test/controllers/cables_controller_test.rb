...
class CablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cable" do
    assert_difference("Cable.count") do
      post cables_url, params: { cable: { cable_type_id: @cable.cable_type_id, length: @cable.length } }
    end
  ...
  test "should update cable" do
    patch cable_url(@cable), params: { cable: { cable_type_id: @cable.cable_type_id, length: @cable.length } }
